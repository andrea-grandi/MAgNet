...
from magnet.evaluation.task_definitions import TASK_DEFINITIONS
...
def run_simple_evaluation():
    ...
    config = EvaluationConfig(
        ...
        tasks=["P11", "P1"],  
        num_runs=3,  # Fewer runs for quick testing
        timeout_seconds=60,
    ...
    try:
        ...
        results = evaluator.run_benchmark(framework_runners) # type: ignore
...
def demonstrate_metrics():
    ...
    from magnet.evaluation.metrics import (
