...
class HITLResumeInfo(TypedDict, total=False):
    """HITL resume information passed from flow to net.

    Attributes:
        task_id: Unique identifier for the task.
        crew_execution_id: Unique identifier for the net execution.
...
class CrewInputsWithHITL(TypedDict, total=False):
    """Net inputs that may contain HITL resume information.
