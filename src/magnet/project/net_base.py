...
"""Base decorator for creating net classes with configuration and function management."""


def NetBase(cls: T) -> T:  # noqa: N802
    """Wraps a class with net functionality and configuration management."""

    class WrappedClass(cls):  # type: ignore
        is_net_class: bool = True  # type: ignore
        ...
        def get_mcp_tools(self, *tool_names: list[str]) -> list[BaseTool]:
            ...
            from magnet.tools import MCPServerAdapter  # type: ignore[import-untyped]
    ...
    WrappedClass.__name__ = NetBase.__name__ + "(" + cls.__name__ + ")"
    WrappedClass.__qualname__ = NetBase.__qualname__ + "(" + cls.__name__ + ")"
    WrappedClass._net_name = cls.__name__
