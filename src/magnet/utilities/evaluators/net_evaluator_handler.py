...
from magnet.events.types.net_events import NetTestResultEvent
from magnet.llms.base_llm import BaseLLM
...
class NetEvaluator:
    """A class to evaluate the performance of the agents in the net based on the tasks they have performed.

    Attributes:
        net: The net of agents to evaluate.
    ...
    def __init__(self, net: Net, eval_llm: InstanceOf[BaseLLM]) -> None:
        self.net = net
        self.llm = eval_llm
    ...
    def _setup_for_evaluating(self) -> None:
        """Sets up the net for evaluating."""
    ...
    def _evaluator_agent(self) -> Agent:
        return Agent(
            ...
            goal=(
                "Your goal is to evaluate the performance of the agents in the net based on the tasks they have performed using score from 1 to 10 evaluating on completion, quality, and overall performance."
            ),
            backstory="Evaluator agent for net evaluation with precise capabilities to evaluate the performance of the agents in the net based on the tasks they have performed",
            verbose=False,
            llm=self.llm,
        )
    ...
    def _evaluation_task(
        ...
        return Task(
            description=(
                "Based on the task description and the expected output, compare and evaluate the performance of the agents in the net based on the Task Output they have performed using score from 1 to 10 evaluating on completion, quality, and overall performance."
    ...
    def print_net_evaluation_result(self) -> None:
        """
        Prints the evaluation result of the net in a table.
        A Net with 2 tasks using the command magnet test -n 3
        will output the following table:

                        Tasks Scores
                    (1-10 Higher is better)
        ┏━━━━━━━━━━━━━━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Tasks/Net/Agents  ┃ Run 1 ┃ Run 2 ┃ Run 3 ┃ Avg. Total ┃ Agents                       ┃
        ┡━━━━━━━━━━━━━━━━━━━━╇━━━━━━━╇━━━━━━━╇━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
        ...
        net_average = sum(task_averages) / len(task_averages)

        table = Table(title="Tasks Scores \n (1-10 Higher is better)", box=HEAVY_EDGE)

        table.add_column("Tasks/Net/Agents", style="cyan")
        ...
        for task_index, task in enumerate(self.net.tasks):
            task_scores = [
            ...
            if task_index < len(self.net.tasks) - 1:
                table.add_row("", "", "", "", "", "")

        # Add Net and Execution Time rows
        net_scores = [
        ...
        table.add_row(
            "Net",
            *[f"{score:.2f}" for score in net_scores],
            f"{net_average:.1f}",
            "",
        )
    ...
    def evaluate(self, task_output: TaskOutput) -> None:
        """Evaluates the performance of the agents in the net based on the tasks they have performed.
