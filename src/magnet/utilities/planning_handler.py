"""Handles planning and coordination of net tasks."""
...
class NetPlanner:
    """Plans and coordinates the execution of net tasks.
    ...
    def __init__(
        ...
        """Initialize NetPlanner with tasks and optional planning agent LLM.
    ...
    def _handle_net_planning(self) -> PlannerTaskPydanticOutput:
        """Handles the Net planning by creating detailed step-by-step plans for each task.
    ...
    def _create_planning_agent(self) -> Agent:
        """Creates the planning agent for the net planning.
        ...
        return Agent(
            ...
            backstory="Planner agent for net planning",
