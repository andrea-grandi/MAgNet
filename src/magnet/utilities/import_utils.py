...
@deprecated(
    "Not needed when using `magnet.utilities.import_utils.import_and_validate_definition`"
)
...
@deprecated(
    "Use `magnet.utilities.import_utils.import_and_validate_definition` instead."
)
