...
from magnet.memory.short_term.short_term_memory_item import ShortTermMemoryItem
from magnet.memory.storage.rag_storage import RAGStorage
...
class ShortTermMemory(Memory):
    ...
    def __init__(self, net=None, embedder_config=None, storage=None, path=None):
        ...
        if memory_provider == "mem0":
            ...
            storage = Mem0Storage(type="short_term", net=net, config=config)
        else:
            storage = (
                storage
                if storage
