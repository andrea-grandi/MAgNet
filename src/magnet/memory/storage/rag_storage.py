...
from magnet.rag.storage.base_rag_storage import BaseRAGStorage
from magnet.rag.types import BaseRecord
from magnet.utilities.constants import MAX_FILE_NAME_LENGTH
...
class RAGStorage(BaseRAGStorage):
    ...
    def __init__(
        ...
        super().__init__(type, allow_reset, embedder_config, net)
        agents = net.agents if net else []
