...
def add_net_attributes(
    span: Span,
    net: "Net",
    add_attribute_fn: Callable[[Span, str, Any], None],
    include_fingerprint: bool = True,
) -> None:
    """Add net attributes to a span.

    Args:
        span: The span to add the attributes to.
        net: The net whose attributes should be added.
        add_attribute_fn: Function to add attributes to the span.
        include_fingerprint: Whether to include fingerprint data.
    """
    add_attribute_fn(span, "net_key", net.key)
    add_attribute_fn(span, "net_id", str(net.id))

    if include_fingerprint and hasattr(net, "fingerprint") and net.fingerprint:
        add_attribute_fn(span, "net_fingerprint", net.fingerprint.uuid_str)
...
def add_net_and_task_attributes(
    span: Span,
    net: "Net",
    task: "Task",
    add_attribute_fn: Callable[[Span, str, Any], None],
    ...
    """Add both net and task attributes to a span.
    ...
    """
    add_net_attributes(span, net, add_attribute_fn, include_fingerprints)
