...
from magnet.flow.config import COLORS, NODE_STYLES
from magnet.flow.html_template_handler import HTMLTemplateHandler
from magnet.flow.legend_generator import generate_legend_items_html, get_legend_items
from magnet.flow.path_utils import safe_path_join
from magnet.flow.utils import calculate_node_levels
from magnet.flow.visualization_utils import (
    add_edges,
    ...
    def _generate_final_html(self, network_html):
        ...
        try:
            ...
            template_path = safe_path_join(
                "assets", "magnet_flow_visual_template.html", root=current_dir
            )
            logo_path = safe_path_join("assets", "magnet_logo.svg", root=current_dir)
