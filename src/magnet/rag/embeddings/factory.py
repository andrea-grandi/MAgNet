...
from magnet.rag.core.base_embeddings_callable import EmbeddingFunction
from magnet.rag.core.base_embeddings_provider import BaseEmbeddingsProvider
from magnet.utilities.import_utils import import_and_validate_definition
...
if TYPE_CHECKING:
    ...
    from magnet.rag.embeddings.providers.ibm.embedding_callable import (
    ...
    from magnet.rag.embeddings.providers.voyageai.embedding_callable import (
...
PROVIDER_PATHS = {
    "azure": "magnet.rag.embeddings.providers.microsoft.azure.AzureProvider",
    "amazon-bedrock": "magnet.rag.embeddings.providers.aws.bedrock.BedrockProvider",
    "cohere": "magnet.rag.embeddings.providers.cohere.cohere_provider.CohereProvider",
    "custom": "magnet.rag.embeddings.providers.custom.custom_provider.CustomProvider",
    "google-generativeai": "magnet.rag.embeddings.providers.google.generative_ai.GenerativeAiProvider",
    "google-vertex": "magnet.rag.embeddings.providers.google.vertex.VertexAIProvider",
    "huggingface": "magnet.rag.embeddings.providers.huggingface.huggingface_provider.HuggingFaceProvider",
    "instructor": "magnet.rag.embeddings.providers.instructor.instructor_provider.InstructorProvider",
    "jina": "magnet.rag.embeddings.providers.jina.jina_provider.JinaProvider",
    "ollama": "magnet.rag.embeddings.providers.ollama.ollama_provider.OllamaProvider",
    "onnx": "magnet.rag.embeddings.providers.onnx.onnx_provider.ONNXProvider",
    "openai": "magnet.rag.embeddings.providers.openai.openai_provider.OpenAIProvider",
    "openclip": "magnet.rag.embeddings.providers.openclip.openclip_provider.OpenCLIPProvider",
    "roboflow": "magnet.rag.embeddings.providers.roboflow.roboflow_provider.RoboflowProvider",
    "sentence-transformer": "magnet.rag.embeddings.providers.sentence_transformer.sentence_transformer_provider.SentenceTransformerProvider",
    "text2vec": "magnet.rag.embeddings.providers.text2vec.text2vec_provider.Text2VecProvider",
    "voyageai": "magnet.rag.embeddings.providers.voyageai.voyageai_provider.VoyageAIProvider",
    "watson": "magnet.rag.embeddings.providers.ibm.watsonx.WatsonXProvider",  # Deprecated alias
    "watsonx": "magnet.rag.embeddings.providers.ibm.watsonx.WatsonXProvider",
}
