...
for NetAI agents. These identifiers are used for tracking, auditing, and security.
"""
...
from magnet.security.constants import MAGNET_AI_NAMESPACE
...
class Fingerprint(BaseModel):
    ...
    def _generate_uuid(cls, seed: str) -> str:
        ...
        return str(uuid5(MAGNET_AI_NAMESPACE, seed))
