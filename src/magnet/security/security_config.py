...
This module provides configuration for NetAI security features, including:
...
class SecurityConfig(BaseModel):
    """
    Configuration for MAgNet security features.

    This class manages security settings for MAgNet agents, including:
