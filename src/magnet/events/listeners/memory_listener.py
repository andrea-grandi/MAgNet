...
class MemoryListener(BaseEventListener):
    ...
    def setup_listeners(self, magnet_event_bus):
        @magnet_event_bus.on(MemoryRetrievalStartedEvent)
        ...
        @magnet_event_bus.on(MemoryRetrievalCompletedEvent)
        ...
        @magnet_event_bus.on(MemoryQueryCompletedEvent)
        ...
        @magnet_event_bus.on(MemoryQueryFailedEvent)
        ...
        @magnet_event_bus.on(MemorySaveStartedEvent)
        ...
        @magnet_event_bus.on(MemorySaveCompletedEvent)
        ...
        @magnet_event_bus.on(MemorySaveFailedEvent)
