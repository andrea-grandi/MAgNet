...
from magnet.events.listeners.tracing.trace_batch_manager import TraceBatchManager
    ...
    def _initialize_backend_and_send_events(self):
        ...
        try:
            if not self.batch_manager.backend_initialized:
                ...
                execution_metadata = {
                    "execution_type": original_metadata.get("execution_type", "net"),
...
You can also add tracing=True to your Net(tracing=True) / Flow(tracing=True) for more control.
