...
class NetAIEventsBus:
    """
    A singleton event bus that uses blinker signals for event handling.
    Allows both internal (Flow/Net) and external event handling.
    """
    ...
    def _initialize(self) -> None:
        ...
        self._signal = Signal("magnet_event_bus")
    ...
    def scoped_handlers(self):
        ...
        Usage:
            with magnet_event_bus.scoped_handlers():
                @magnet_event_bus.on(NetKickoffStarted)
...
# Global instance
magnet_event_bus = NetAIEventsBus()
