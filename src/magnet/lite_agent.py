...
from magnet.events.types.logging_events import AgentLogsExecutionEvent
...
from magnet.utilities import I18N
...
class LiteAgent(FlowTrackable, BaseModel):
    ...
    where a full net is not needed.
    ...
    # Private Attributes
    _parsed_tools: list[NetStructuredTool] = PrivateAttr(default_factory=list)
    ...
    def parse_tools(self):
        """Parse the tools and convert them to NetStructuredTool instances."""
