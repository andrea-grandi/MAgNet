...
class ProviderFactory:
    ...
    def from_settings(cls, settings: Optional[Oauth2Settings] = None):
        ...
        module = importlib.import_module(
            f"magnet.cli.authentication.providers.{settings.provider.lower()}"
        )
...
class AuthenticationCommand:
    ...
    def _login_to_tool_repository(self) -> None:
        ...
        from magnet.cli.tools.main import ToolCommand
        ...
        try:
            ...
            console.print(
                ...
                "\nRun [bold]magnet login[/bold] to try logging in again.\n",
                style="yellow",
            )
