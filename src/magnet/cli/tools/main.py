...
class ToolCommand(BaseCommand, PlusAPIMixin):
    ...
    def publish(self, is_public: bool, force: bool = False):
        ...
        console.print(
            ...
            + f"You can monitor the status or access your tool here:\nhttps://app.magnet.com/crewai_plus/tools/{published_handle}",
            style="bold green",
        )
    ...
    def login(self) -> None:
        ...
        if login_response.status_code != 200:
            console.print(
                "Authentication failed. Verify access to the tool repository, or try `magnet login`. ",
                style="bold red",
            )
            raise SystemExit
