...
from magnet.cli.command import BaseCommand
from magnet.cli.config import Settings, READONLY_SETTINGS_KEYS, HIDDEN_SETTINGS_KEYS
...
class SettingsCommand(BaseCommand):
    ...
    def reset_all_settings(self) -> None:
        ...
        self.settings.reset()
        console.print(
            "Successfully reset all configuration parameters to default values. It is recommended to run [bold yellow]'magnet login'[/bold yellow] to re-authenticate.",
            style="bold green",
        )
