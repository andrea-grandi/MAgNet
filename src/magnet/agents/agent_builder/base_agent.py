...
from magnet.agents.agent_builder.utilities.base_token_process import TokenProcess
from magnet.agents.cache.cache_handler import CacheHandler
from magnet.agents.tools_handler import ToolsHandler
from magnet.knowledge.knowledge import Knowledge
from magnet.knowledge.knowledge_config import KnowledgeConfig
...
from magnet.utilities import I18N, Logger, RPMController
...
class BaseAgent(ABC, BaseModel):
    """Abstract Base Class for all third party agents.
    ...
    Attributes:
        ...
        agent_executor (InstanceOf): An instance of the NetAgentExecutor class.
        llm (Any): Language model that will run the agent.
        net (Any): Network to which the agent belongs.
    ...
    Methods:
        ...
        get_delegation_tools(agents: List["BaseAgent"]):
            Abstract method to set the agents task tools for handling delegation and question asking to other agents in net.
    ...
    agent_executor: InstanceOf = Field(
        default=None, description="An instance of the NetAgentExecutor class."
    )
    llm: Any = Field(
        default=None, description="Language model that will run the agent."
    )
    net: Any = Field(default=None, description="Net to which the agent belongs.")
