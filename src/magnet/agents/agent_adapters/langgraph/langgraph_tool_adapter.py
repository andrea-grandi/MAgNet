"""LangGraph tool adapter for MAgNet tool integration.

This module contains the LangGraphToolAdapter class that converts MAgNet tools
...
from magnet.agents.agent_adapters.base_tool_adapter import BaseToolAdapter
from magnet.tools.base_tool import BaseTool


class LangGraphToolAdapter(BaseToolAdapter):
    """Adapts MAgNet tools to LangGraph agent tool compatible format.

    Converts BaseTool instances to langchain_core.tools format
    ...
    def __init__(self, tools: list[BaseTool] | None = None) -> None:
        ...
        Args:
            tools: Optional list of tools to adapt.
        """
        super().__init__()
    ...
    def configure_tools(self, tools: list[BaseTool]) -> None:
        """Configure and convert MAgNet tools to LangGraph-compatible format.

        LangGraph expects tools in langchain_core.tools format. This method
        converts BaseTool instances to StructuredTool instances.
        ...
        for tool in all_tools:
            ...
            async def tool_wrapper(
                *args: Any, tool: BaseTool = tool, **kwargs: Any
                ...
                """Wrapper function to adapt tool calls to LangGraph format.
