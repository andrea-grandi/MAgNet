"""LangGraph agent adapter for MAgNet integration.

This module contains the LangGraphAgentAdapter class that integrates LangGraph ReAct agents
with MAgNet's agent system. Provides memory persistence, tool integration, and structured
...
from magnet.agents.agent_adapters.base_agent_adapter import BaseAgentAdapter
from magnet.agents.agent_adapters.langgraph.langgraph_tool_adapter import (
    LangGraphToolAdapter,
)
from magnet.agents.agent_adapters.langgraph.protocols import (
    LangGraphCheckPointMemoryModule,
    LangGraphPrebuiltModule,
)
from magnet.agents.agent_adapters.langgraph.structured_output_converter import (
...
from magnet.utilities.converter import Converter
from magnet.utilities.import_utils import require


class LangGraphAgentAdapter(BaseAgentAdapter):
    """Adapter for LangGraph agents to work with MAgNet.

    This adapter integrates LangGraph's ReAct agents with MAgNet's agent system,
