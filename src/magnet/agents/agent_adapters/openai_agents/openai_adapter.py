"""OpenAI agents adapter for MAgNet integration.

This module contains the OpenAIAgentAdapter class that integrates OpenAI Assistants
with MAgNet's agent system, providing tool integration and structured output support.
"""
...
from magnet.agents.agent_adapters.openai_agents.openai_agent_tool_adapter import (
    OpenAIAgentToolAdapter,
)
from magnet.agents.agent_adapters.openai_agents.protocols import (
    AgentKwargs,
    OpenAIAgentsModule,
)
from magnet.agents.agent_adapters.openai_agents.protocols import (
...
from magnet.agents.agent_adapters.openai_agents.structured_output_converter import (
...
class OpenAIAgentAdapter(BaseAgentAdapter):
    ...
    Integrates OpenAI Assistants API with MAgNet agent system, providing
