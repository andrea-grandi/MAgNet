"""OpenAI agent tool adapter tool integration.

This module contains the OpenAIAgentToolAdapter class that converts MAgNet tools
...
class OpenAIAgentToolAdapter(BaseToolAdapter):
    ...
    Converts BaseTool instances to OpenAI Assistant FunctionTool format
    ...
    def _convert_tools_to_openai_format(
        ...
        """Convert MAgNet tools to OpenAI Assistant tool format.
        ...
        def create_tool_wrapper(tool: BaseTool) -> Any:
            ...
            async def wrapper(context_wrapper: Any, arguments: Any) -> Any:
                """Wrapper function to adapt tool calls to OpenAI format.
