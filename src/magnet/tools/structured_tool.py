...
class NetStructuredTool:
    ...
    that integrates better with NetAI's ecosystem.
    """
    ...
    def from_function(
        ...
        **kwargs: Any,
        ...
        Returns:
            A NetStructuredTool instance

        Example:
            >>> def add(a: int, b: int) -> int:
            ...     '''Add two numbers'''
            ...     return a + b
            >>> tool = NetStructuredTool.from_function(add)
        """
    ...
    def __repr__(self) -> str:
        return (
            f"NetStructuredTool(name='{self.name}', description='{self.description}')"
        )
