...
class BaseTool(BaseModel, ABC):
    ...
    def to_structured_tool(self) -> NetStructuredTool:
        """Convert this tool to a NetStructuredTool instance."""
        self._set_args_schema()
        structured_tool = NetStructuredTool(
            name=self.name,
    ...
    def from_langchain(cls, tool: Any) -> "BaseTool":
        """Create a Tool instance from a NetStructuredTool.

        This method takes a NetStructuredTool object and converts it into a
...
class Tool(BaseTool):
    ...
    def from_langchain(cls, tool: Any) -> "Tool":
        ...
        Args:
            tool (Any): The NetStructuredTool object to be converted.

        Returns:
            Tool: A new Tool instance created from the provided NetStructuredTool.
...
def to_langchain(
    tools: list[BaseTool | NetStructuredTool],
) -> list[NetStructuredTool]:
