...
from magnet.events.types.task_events import TaskCompletedEvent
...
from magnet.experimental.evaluation.evaluation_display import EvaluationDisplayFormatter
...
class AgentEvaluator:
    ...
    def _subscribe_to_events(self) -> None:
        ...
        magnet_event_bus.register_handler(
    ...
    def get_agent_evaluation(
        ...
        agent_results = {}
        with magnet_event_bus.scoped_handlers():
...
def create_default_evaluator(agents: list[Agent] | list[BaseAgent], llm: None = None):
    from magnet.experimental.evaluation import (
