...
from magnet.utilities.constants import KNOWLEDGE_DIRECTORY
from magnet.utilities.logger import Logger


class NetDoclingSource(BaseKnowledgeSource):
    ...
    def __init__(self, *args, **kwargs):
        if not DOCLING_AVAILABLE:
            raise ImportError(
                "The docling package is required to use NetDoclingSource. "
