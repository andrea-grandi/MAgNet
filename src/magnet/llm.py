...
class LLM(BaseLLM):
        ...
        try:
            ...
            for chunk in litellm.completion(**params):
                ...
                if chunk_content is not None:
                    ...
                    if not hasattr(magnet_event_bus, "emit"):
                        raise Exception("magnet_event_bus must have an `emit` method")
            ...
            # This exception is handled by NetAgentExecutor._invoke_loop() which can then
            ...
            if not hasattr(magnet_event_bus, "emit"):
                raise AttributeError(
                    "magnet_event_bus must have an 'emit' method"
                ) from e
            magnet_event_bus.emit(
                self,
    ...
    def _handle_streaming_tool_calls(
        ...
        for tool_call in tool_calls:
            ...
            if not hasattr(magnet_event_bus, "emit"):
                raise AttributeError("magnet_event_bus must have an 'emit' method")
            magnet_event_bus.emit(
                self,
                event=LLMStreamChunkEvent(
    ...
    def _handle_non_streaming_response(
        ...
        try:
            ...
            # across the codebase. This allows NetAgentExecutor to handle context
    ...
    def call(
        ...
        with suppress_warnings():
            ...
            try:
                ...
                # by the NetAgentExecutor._invoke_loop method, which can then decide
